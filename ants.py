...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while place != beehive:
            if len(place.bees)>0 and (self.min_range <= detect_range <= self.max_range):
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting:
            ...
            lst_copy = list(self.place.bees)
            if lst_copy:
                self.eat_bee(rANTdom_else_none(lst_copy))
        # END Problem 6
    ...
    def action(self, gamestate):
        ...
        if self.imposter:
            ...
            while place != None:
                ...
                if place.ant != None and place.ant not in self.doubled_damage:
                    place.ant.damage *= 2
